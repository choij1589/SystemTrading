"""
ETF Backtesting Engine V2 (Refactored)

주요 개선사항:
1. 슬리피지 로직 수정 (bid-ask spread 모델링)
2. 리밸런싱 시 비례적 현금 부족 처리
3. 코드 명확성 및 주석 개선
4. 성능 최적화
"""
...
if __name__ == "__main__":
    print("ETF Backtesting Engine V2 (Refactored)")
    print("=" * 60)
    print("주요 개선사항:")
    print("1. 슬리피지 → bid-ask spread 모델링")
    print("2. 리밸런싱 시 비례적 현금 부족 처리")
    print("3. 코드 명확성 및 주석 개선")
